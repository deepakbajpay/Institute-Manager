...
public class ActivityStudentMarks extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle(Html.fromHtml("<font color='#FFFFFF'>Student Marks</font>"));

        databaseHelper = new DatabaseHelper(ActivityStudentMarks.this);
    ...
    public void setAdapter() {
        ArrayList<Marks> markses = databaseHelper.getMyMarks(SharedPrefs.getString(this,SharedPrefs.roll));
        AdapterMarks adapterMarks = new AdapterMarks(ActivityStudentMarks.this, markses, Constants.TYPE_MARKS);
